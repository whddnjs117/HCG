...
(
  ...
  CONSTRAINT NI_PR3110_PR3010
  FOREIGN KEY (C_CD, UNIF_CD) REFERENCES PR3110
);

COMMENT ON TABLE PR3010 IS '(PR3010)유니폼지급회차관리';

COMMENT ON COLUMN PR3010.C_CD IS '회사코드';
COMMENT ON COLUMN PR3010.UNIF_CD IS '유니폼코드';
COMMENT ON COLUMN PR3010.GIV_STD_ID IS '지급회차ID';
COMMENT ON COLUMN PR3010.GIV_STD_NM IS '지급\회차명';
...
COMMENT ON COLUMN PR3010.STD_YMD IS '지급일';
COMMENT ON COLUMN PR3010.GIV_PGR_YN IS '지급진행여부';
