...
CALL P_PR_UNIF_TARG_CHEK('10', '20190405-e2l', '인사총무팀', '6030');

-----------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE P_PR_UNIF_TARG_CHEK(I_C_CD VARCHAR2 := NULL,
                                                I_GIV_TRG_NM VARCHAR2 := NULL,
                                                I_ORG_NM VARCHAR2 := NULL,
                                                I_EMP_GRADE_CD VARCHAR2 := NULL)
IS
  --   V_GIV_STD_ID VARCHAR2(60);
  --   V_EMP_ID VARCHAR2(60);
  --   V_EMP_NM VARCHAR2(60);
  --   V_GENDER_TYPE VARCHAR2(60);
  --   V_ORG_ID VARCHAR2(60);
  --   V_ORG_NM VARCHAR2(60);
  --   V_EMP_GRADE_CD VARCHAR2(60);
  --   V_APPL_ID VARCHAR2(60);
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('PR3210 테이블에 값 삽입');
...
--                         FROM TB_NAME
--
--                         WHERE COLUMN_NAME1 = 'COLUMN_VAL1'
--
--                         )
