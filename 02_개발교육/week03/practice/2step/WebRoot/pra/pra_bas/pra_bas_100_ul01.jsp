...
function LoadPage()
{
  ...
  arrC[col++] = {Header:"<com:label key='emp_id' def='사번' />",             Type:"Popup",       SaveName:"EMP_ID",          Width:100,     Align:"Center",       UpdateEdit:1,       UpdateEdit:0,       KeyField:1};
  arrC[col++] = {Header:"<com:label key='emp_nm' def='성명' />",             Type:"Text",        SaveName:"EMP_NM",          Width:70,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='sta_ymd' def='시작일' />",          Type:"Date",        SaveName:"STA_YMD",         Width:90,      Align:"Center",       KeyField:1};
  arrC[col++] = {Header:"<com:label key='end_ymd' def='종료일' />",          Type:"Date",        SaveName:"END_YMD",         Width:90,      Align:"Center",       KeyField:1};
  arrC[col++] = {Header:"<com:label key='equip_cd' def='장비코드' />",       Type:"Text",        SaveName:"EQUIP_CD",        Width:70,      Align:"Center",       KeyField:1};
...
<input type="hidden" id="S_DSCLASS"        name="S_DSCLASS"         value="<com:otp value="biz.pra.pra_bas.Pra_bas_100_ul01" />" />
