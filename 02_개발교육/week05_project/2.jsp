...
function LoadPage()
{
  ...
  arrC[col++] = {Header:"<com:label key='emp_id' def='사번' />",              Type:"Popup",       SaveName:"EMP_ID",          Width:80,      Align:"Right",        InsertEdit:1,       UpdateEdit:0,        KeyField:1};
  arrC[col++] = {Header:"<com:label key='emp_nm' def='성명' />",              Type:"Text",        SaveName:"EMP_NM",          Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='org_nm' def='조직' />",              Type:"Text",        SaveName:"ORG_NM",          Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='emp_title' def='호칭' />",           Type:"Text",        SaveName:"EMP_TITLE_NM",    Width:80,      Align:"Center",       Hidden:1,           InsertEdit:0,        UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='emp_grade' def='직급' />",           Type:"Combo",       SaveName:"EMP_GRADE_CD",    Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='duty_nm' def='직책' />",             Type:"Text",        SaveName:"DUTY_NM",         Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='gender_type' def='성별' />",         Type:"Combo",       SaveName:"GENDER_TYPE",     Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0};
  arrC[col++] = {Header:"<com:label key='giv_std_id' def='장비회차ID' />",    Type:"Text",        SaveName:"GIV_STD_ID",      Width:80,      Align:"Center",       InsertEdit:0,       UpdateEdit:0, Hidden:1};
